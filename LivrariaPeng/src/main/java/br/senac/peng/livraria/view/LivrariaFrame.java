package br.senac.peng.livraria.view;
...
import br.senac.peng.livraria.dao.LivrariaDAO;
...
public class LivrariaFrame extends JFrame {
	...
	public LivrariaFrame() {
		...
		try {
            this.dataLancamentoField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
